...
//admin users route
app.get('/admin/billeder', async (req,res, next) => {
...
app.post('/admin/billeder', async (req, res, next) => {
    try {
        let imagelist = [];
...
app.get('/admin/billeder/:name', (req, res, next) => {
...
app.post('/admin/billeder/:name', async (req, res, next) => {
    try {
